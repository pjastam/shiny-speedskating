...
If you do not want to deploy your Docker app manually, there is a way out. We included example code to programmatically (1) create a Digital Ocean server and (2) deploy your Docker app to this server. To this end, the [analogsea](https://github.com/sckott/analogsea) package is used. The example code is in the file
